...
module.exports = function (adminFields) {
  ...
  return function (vs) {
    ...
    if (vs.isset('input:street')) { return ngrams_last_token_only(vs, false); }
    ...
    if (!complete_tokens || complete_tokens.length < 1) { return ngrams_last_token_only(vs, false); }
    ...
    if (all_complete_tokens_numeric) { return ngrams_last_token_only(vs, false); }
